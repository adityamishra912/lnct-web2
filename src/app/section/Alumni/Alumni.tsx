...
export default function Alumni() {
    ...
    return (
        <section className="flex flex-col items-center">
            ...
            <div className="bg-black w-[90vw] rounded-[50px_50px_50px_50px] flex flex-col items-center">
                <div className="h-[80px] flex justify-center items-center text-center my-10"><h1 className="text-white text-6xl font-extrabold">Notable Alumni</h1></div>

                <div className="w-[80vw] flex justify-center items-center mb-10">
